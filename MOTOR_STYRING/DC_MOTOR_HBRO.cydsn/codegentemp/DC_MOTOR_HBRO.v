// ======================================================================
// DC_MOTOR_HBRO.v generated from TopDesign.cysch
// 02/10/2022 at 17:27
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c91a2599-2fda-4f7e-85c0-3a7f165099d8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5a0b692e-cd8d-4cee-b899-fd1f1ad7a361"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
